...
keys to generate the short_url URLs.  For example, when creating a new URL, the 
...
integer is not used twice, the same short_url URL will not be generated twice.
...
DEFAULT_LETTERS = 'Ud82GgcSXaHq1bkt4foYzOJDCwu5ZBh3yl0FEV9TnpK7QxmIrMWAe6ivNRPLsj'
DEFAULT_BLOCK_SIZE = 24
MIN_LENGTH = 5


class UrlEncoder(object):
    def __init__(self, alphabet=DEFAULT_LETTERS, block_size=DEFAULT_BLOCK_SIZE):
